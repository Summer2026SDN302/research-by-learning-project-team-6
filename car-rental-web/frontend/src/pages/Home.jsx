          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="bg-white/5 border border-white/10 rounded-3xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 backdrop-blur-xl shadow-2xl shadow-black/30">
              <div>
                ...
                <h3 className="text-2xl md:text-3xl font-black mt-2">Log in to manage your vehicle.</h3>
                <p className="text-gray-500 mt-2">View your booking history, payments, and exclusive member offers.</p>
              </div>

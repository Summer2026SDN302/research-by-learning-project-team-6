...
router.get('/dashboard-stats', async (req, res) => {
    try {
        ...
        // Convert monthly revenue to object format
...
router.get('/car-type-distribution', async (req, res) => {
    try {
...
// Get pricing surge data
router.get('/pricing-surge', async (req, res) => {
    try {
        // Get bookings grouped by date to identify surge periods
        ...
        // Identify surge periods (above average demand)
...
// Get car availability during surge periods
router.get('/surge-availability', async (req, res) => {
    try {
        ...
        // Get availability status for those dates
        const totalCars = await Car.countDocuments();
